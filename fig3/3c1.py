...
def _build_riv_og_data():
    ...
    Z = np.loadtxt("csv/Tom_Science_symmetric_linear_transposed.csv", delimiter=",")
...
def plot_riv_og(ax_heatmap, ax_line, add_colorbar=True):
    ...
    ax_line.set(xlim=[0.5, 3.5], ylim=[-g_range, g_range])
    ax_line.set_xticks([1, 2, 3])
...
def main():
    ...
    fig_heatmap.savefig("3c1.png", dpi=300)

    # We don't need any of this for our purposes here
