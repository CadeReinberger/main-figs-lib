...
beta_prime_data = np.array([45, 40, 15, 0, -45])
...
ax.plot(beta_prime_theory, alpha_theory, label='Theory', color='steelblue', linewidth=2)
ax.scatter(beta_prime_data, alpha_data, label='Data', color='tomato', s=60, zorder=5)
plt.xlim((-60, 60))
